...
function getRoutes(callback) {
    request.get('https://mke-bus.herokuapp.com/get/all/routes', parseSuccess.bind(null, callback))
}
...
function getDirectionsByRoute(route, callback) {
    request.get('https://mke-bus.herokuapp.com/get/all/directions/where?' + qs({
        route_id: route.id
...
function getStopsByRouteDirection(route, direction, callback) {
    request.get('https://mke-bus.herokuapp.com/get/all/stops/where?' + qs({
        route_id: route.id,
        direction: direction
    }), parseSuccess.bind(null, callback))
}
